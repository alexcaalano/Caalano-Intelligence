...
async function clientUpdate(apiKey, body) {
  const { clientName, firstName, period, periodDays, clientContext = '', kpis: k = {}, channels: ch = {}, forecast: fc = {}, creatives: cr = [], pipelines: pls = [], segments: segs = [], appts: ap = null, lostReasons: lr = [], avgCloseDays = null, nonBookerNotes: nbn = [], stalled: stl = [] } = body
  const pv = k.prev || {}
