    ...
    if (req.method === 'GET') {
      ...
      if (secret) {
        ...
        if (isClientRole(me.role)) {
          ...
          for (const s of ['keyevents', 'kpis', 'enabled', 'clients', 'formmeta', 'qualstage', 'aliases', 'logos', 'metaconv', 'adnames', 'clinic', 'campmap', 'geo', 'dashboards', 'repkpis', 'goals', 'mreport']) scoped[s] = pick(data[s])
