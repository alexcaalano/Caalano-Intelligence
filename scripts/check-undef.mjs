...
const DEFAULT_FILES = ['src/App.jsx', 'src/views/sales-hub.jsx', 'src/views/settings.jsx', 'src/views/creative.jsx', 'src/views/monthly-report.jsx', 'netlify/functions/windsor.mjs', 'netlify/lib/ghl.mjs', 'netlify/lib/cred.mjs', 'netlify/lib/providers/index.mjs', 'netlify/lib/providers/windsor.mjs', 'netlify/lib/entitle.mjs', 'netlify/lib/db.mjs']
